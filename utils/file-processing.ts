import { getNomPrenom } from "./get-nom-prenom";
  ...
  BYTEL: {
    mapColumnMASTER_BYTEL: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[21],
        Recherche: item?.[22],
        nom: getNomPrenom(item?.[23]),
        prenom: getNomPrenom(item?.[24]),
        Ville: item?.[25],
        utm_device: item?.[26],
        lead_device: item?.[27],
    ...
    mapColumnADM: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[37],
        Recherche: item?.[41],
        nom: getNomPrenom(item?.[39]),
        prenom: getNomPrenom(item?.[40]),
        Ville: "",
        utm_device: item?.[42],
        lead_device: item?.[43],
    ...
    mapColumnEUROCRM: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[43],
        Recherche: item?.[44],
        nom: getNomPrenom(item?.[17]),
        prenom: getNomPrenom(item?.[18]),
        Ville: "",
        utm_device: item?.[45],
        lead_device: "",
    ...
    mapColumnVIPP: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[47],
        Recherche: "",
        nom: getNomPrenom(item?.[55]),
        prenom: getNomPrenom(item?.[56]),
        Ville: "",
        utm_device: item?.[52],
        lead_device: "",
    ...
    mapColumnWEBHELP: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[34],
        Recherche: item?.[43],
        nom: getNomPrenom(item?.[41]),
        prenom: getNomPrenom(item?.[42]),
        Ville: "",
        utm_device: item?.[43],
        lead_device: "",
    ...
    mapColumnALGER: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[28],
        Recherche: item?.[31],
        nom: getNomPrenom(item?.[32]),
        prenom: getNomPrenom(item?.[33]),
        Ville: "",
        utm_device: item?.[35],
        lead_device: item?.[34],
    ...
    mapColumnQUALITY_CENTER: (item: string[]) => {
      const Fournisseur_actuel = item?.[15];
      const Preference = item?.[19];
      const formatedPreference = getPreference(Fournisseur_actuel, Preference);
      const ID = generateNumericId();
  ...
  ORANGE: {
    ...
    mapColumnKONECTA: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[46],
        Recherche: item?.[58],
        nom: getNomPrenom(item?.[59]),
        prenom: getNomPrenom(item?.[60]),
        Ville: "",
        utm_device: item?.[62],
        lead_device: "",
        operateur_mobile: item?.[53],
    ...
    mapColumnSATEL: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[33],
        Recherche: item?.[31],
        nom: getNomPrenom(item?.[25]),
        prenom: getNomPrenom(item?.[26]),
        Ville: "",
        utm_device: item?.[29],
        lead_device: "",
    ...
    mapColumnCASABLANCA: (item: string[]) => {
      const Fournisseur_actuel = item?.[15];
      const Preference = item?.[19];
      const formatedPreference = getPreference(Fournisseur_actuel, Preference);
      const ID = generateNumericId();
  ...
  SFR: {
    ...
    mapColumnAFFINICIA: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[32],
        Recherche: item?.[35],
        nom: getNomPrenom(item?.[36]),
        prenom: getNomPrenom(item?.[37]),
        Ville: "",
        utm_device: item?.[39],
        lead_device: "",
    ...
    mapColumnRIGHTPLACE: (item: string[]) => {
      ...
      return {
        ...
        Prix: item?.[29],
        Recherche: item?.[32],
        nom: getNomPrenom(item?.[33]),
        prenom: getNomPrenom(item?.[34]),
        Ville: "",
        utm_device: item?.[36],
        lead_device: item?.[35],
        operateur_mobile: item?.[31],
    ...
    mapColumnQC_SFR: (item: string[]) => {
      const Fournisseur_actuel = item?.[15];
      const Preference = item?.[19];
      const formatedPreference = getPreference(Fournisseur_actuel, Preference);
      const ID = generateNumericId();
      const getOpparator = (item: string[]) =>
        item?.[31] === undefined ? item?.[25] : item?.[31];
      ...
      return {
        ...
        utm_device: "",
        lead_device: "",
        operateur_mobile: getOpparator(item),
        is_internal: "true",
      };
    },
